...
<div class="wrapper">
    <div class="main-header">
        <div class="logo-header" data-background-color="blue">
            ...
            <button class="navbar-toggler sidenav-toggler ml-auto" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
    ...
    <div class="main-panel">
        <div class="content">
            ...
            <div class="page-inner mt--5">
                <div class="row">
                    <div class="page-category col-md-12">@yield('content')</div>
                </div>
            </div>
        </div>
    </div>
